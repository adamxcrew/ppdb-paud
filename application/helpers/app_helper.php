...
function _waliByLogin($id){
    
    $ci =& get_instance();
    $data = $ci->db->get_where('wali',['pengguna_id'=>$id])->row_array();
    return $data;
...
function _wali($id){
    ...
    $ci =& get_instance();
    $data = $ci->db->get_where('wali',['idwali'=>$id])->row_array();
    return $data;
...
function namaBukti($id){
    
    $ci =& get_instance();
    $data = $ci->db->get_where('pembayaran',['idpembayaran'=>$id])->row();
    return $data->file_bukti;
